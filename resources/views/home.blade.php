...
<section id="inicio" class="relative h-[calc(100dvh-64px)] min-h-[600px] flex items-center justify-center bg-primary-700 text-white overflow-hidden">
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col justify-center h-full">
        <div class="animate-fade-in">
            <p class="text-sm font-semibold tracking-[0.3em] uppercase text-white/60 mb-3">IAGUS</p>
...
<section id="cultos" class="py-20 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            <span class="inline-block px-4 py-1 bg-primary-100 text-primary-700 rounded-full text-sm font-semibold mb-4">Horários</span>
            <h2 class="text-4xl font-bold text-gray-900 mb-4">Cultos e Agenda</h2>
            <p class="text-xl text-gray-600 max-w-2xl mx-auto">Participe dos nossos encontros semanais de celebração e comunhão</p>
        </div>
        
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <!-- Domingo -->
            <div class="group bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                <div class="h-2 bg-gradient-to-r from-primary-400 to-primary-600"></div>
                <div class="p-8 text-center">
                    <div class="w-20 h-20 bg-primary-50 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 group-hover:bg-primary-100 transition-all duration-300">
                        <svg class="w-10 h-10 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-1">Domingo</h3>
                    <p class="text-sm text-gray-500 mb-4">Manhã</p>
                    <p class="text-5xl font-bold text-primary-600 mb-4">9:00</p>
                    <div class="w-12 h-1 bg-primary-200 rounded-full mx-auto mb-4"></div>
                    <p class="text-gray-700 font-medium mb-2">Culto de Celebração</p>
                    <p class="text-sm text-gray-500">Louvor, adoração e mensagem bíblica</p>
                </div>
            </div>
            ...
            <div class="group bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                ...
                <div class="p-8 text-center">
                    <div class="w-20 h-20 bg-indigo-50 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 group-hover:bg-indigo-100 transition-all duration-300">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-1">Quarta-feira</h3>
                    <p class="text-sm text-gray-500 mb-4">Noite</p>
                    <p class="text-5xl font-bold text-indigo-600 mb-4">19:30</p>
                    <div class="w-12 h-1 bg-indigo-200 rounded-full mx-auto mb-4"></div>
                    <p class="text-gray-700 font-medium mb-2">Culto de Oração e Ensino</p>
                    <p class="text-sm text-gray-500">Momento de oração e estudo bíblico</p>
                </div>
            </div>
        </div>
        
        <!-- Info adicional -->
        <div class="mt-12 bg-white rounded-xl shadow-md border border-gray-200 p-6 max-w-3xl mx-auto">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="flex items-center justify-center gap-3 text-gray-700">
                    ...
                    <span class="text-sm font-medium">Estacionamento disponível</span>
                </div>
                <div class="flex items-center justify-center gap-3 text-gray-700">
                    <div class="w-10 h-10 bg-green-50 rounded-lg flex items-center justify-center">
                        <svg class="w-5 h-5 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <span class="text-sm font-medium">Ambiente familiar</span>
                </div>
                <div class="flex items-center justify-center gap-3 text-gray-700">
                    <div class="w-10 h-10 bg-green-50 rounded-lg flex items-center justify-center">
                        <svg class="w-5 h-5 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <span class="text-sm font-medium">Ministério infantil</span>
                </div>
            </div>
        </div>
    </div>
